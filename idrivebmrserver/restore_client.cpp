...
namespace
{
	...
	public:
		...
		void operator()()
		{
			...
			fileserv->shareDir("idrivebmr", "/tmp/mkmergsdfklrzrehmklregmfdkgfdgwretklödf", identity, false);
			ClientMain::addShareToCleanup(curr_clientid, SShareCleanup("idrivebmr", identity, false, false));
